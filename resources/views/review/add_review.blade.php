    ...
    <div class="bg-white rounded shadow-sm p-4 mb-4 restaurant-detailed-ratings-and-reviews">
          ...
          <div class="reviews-members pt-4 pb-4">
            ...
            <div class="media d-flex">
              <a href="#"><img alt="Generic placeholder image" src="{{ asset('images/profile.png') }}"
              ...
              <div class="media-body w-100">
                <div class="d-flex justify-content-between align-items center">
                  ...
                  <div class="col-1 d-flex justify-content-evenly">
                    <!-- <a class="link_edit_review" title="edit review" href="/review/edit_review/{{ $review->id }}">
        ...
        <!-- sec end -->
<form action="/review/add_review/ {{ $product->id }}" method="post">
          @csrf
