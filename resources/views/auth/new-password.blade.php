                        ...
                        <div class="col-lg">
                            <div class="p-5">
                                ...
                                <form class="user" method="post" action="{{route('reset.password.post')}}">
                                    ...
                                    <div class="form-group">
                                        <input type="password"
                                          class="form-control @error('password_confirmation') is-invalid @enderror" id="c_password"
                                          name="password_confirmation" placeholder="Confirm Password" data-toggle="password_confirm">
